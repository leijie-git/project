    ...
    $.fn.bootstrapTreeTable = function(options, param) {
        ...
        target.getRootNodes = function(data) {
            ...
            $.each(data, function(index, item) {
                ...
                || item[options.parentCode] == undefined;
        ...
        target.renderRow = function(tr,item){
            $.each(options.columns, function(index, column) {
                ...
                if(index==0&&column.field=='selectItem'){
                    hasSelectItem = true;
                    var td = $('<td style="text-align:left;width:36px"></td>');
                    if(column.radio){
                ...
                // else if(index==4&&column.field=='operation'){
                //     var td = $('<td style="text-align:left;width:36px"></td>');
                //     // var _ipt = $('<span class="glyphicon glyphicon-edit" aria-hidden="true"></span><span class="glyphicon glyphicon-trash"></span><span class="glyphicon glyphicon-eye-open"></span>');
                //     // td.append(_ipt);
                //     tr.append(td);
                // }else if(index==8&&column.field=='operation'){
                //     var td = $('<td style="text-align:left;width:36px"></td>');
                //     var _ipt = $('<span class="glyphicon glyphicon-edit" aria-hidden="true"></span><span class="glyphicon glyphicon-trash"></span><span class="glyphicon glyphicon-eye-open"></span>');
                //     td.append(_ipt);
                //     tr.append(td);
