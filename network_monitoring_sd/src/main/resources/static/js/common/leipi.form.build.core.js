...
$(document).ready(function(){
  ...
  $("#components,#target").delegate(".component", "mousedown", function(md){
    $(".popover").remove();
    ...
    var delayed = setTimeout(function(){
      ...
      $temp.css({"position" : "absolute",
                 ...
                 "top"      : $this[0].getBoundingClientRect().top + "px",
                 "left"     :  $this[0].getBoundingClientRect().left + "px",
                 "z-index"     : 2000,
                 "opacity"  : "0.9"}).show()
      ...
      var tar_pos = $target[0].getBoundingClientRect();
