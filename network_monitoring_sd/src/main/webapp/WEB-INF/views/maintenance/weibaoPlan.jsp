            ...
            <div class="col-md-12">
                <div class="jy_wrapper">
                    <ul class="jy_title">
                        ...
                        <li class="no_active"><span class="title">维保计划录入</span></li>
                    </ul>
                </div>
                 <div class="jy_mainTile panel-heading" style="display: none" clickNo="0">
                        <div class="form-inline">
                            <div class="form-group">
                                <label for="identityNo" class="control-label">建筑<strong>
                                        :</strong></label>
                                <td class="text-left">
                                    ...
                                    <label for="identityNo" class="control-label">区域<strong>
                                        :</strong></label> <%--<input type="text" class="form-control"
                                    id="defaultUserName">--%>

                                <td class="text-left">
                                    <select class="form-control inputWidth" id="buildAreaIdSearch" <%--disabled="disabled"--%>>
                                        <%-- <option value="0">--请选择--</option>--%>
                                    </select>
                                </td>
                                <label for="identityNo" class="control-label">执行人<strong>
                                    :</strong></label>
                                <select class="form-control inputWidth" id="executor" >
                            ...
                            <div style="display: none;" >
                                ...
                                <label for="identityNo" class="control-label">维保计划<strong>
                                    :</strong></label>
                                <input class="form-control inputWidth" id="planNames" <%--disabled="disabled"--%>>
                                <%-- <option value="0">--请选择--</option>--%>
                                </input>
                                <label for="identityNo" class="control-label">单位<strong>
                                    :</strong></label>
                                <input class="form-control inputWidth" id="unitName" <%--disabled="disabled"--%>>
                                <%-- <option value="0">--请选择--</option>--%>
                                </input>
                    ...
                    <div class="jy_new" style="top: 6px;">
                        <div class="form-inline">
                            ...
                            <select name="menuType" id="menuType" class="form-control">
                                     <option value="planNames">维保计划</option>
                                     <option value="unitName">单位</option>
                                </select>
                                <span id="commonInput"><input type="text"
                                    class="form-control showInput" name="searchContent"
                         ...
                         <c:if test="${userSession.unitId != null and userSession.unitId != ''}">
                            ...
                            <!--                             </button> -->
                            <button type="button" class="btn btn-primary generateTask">
                                <i class="fa fa-floppy-o"></i>&nbsp;生成任务
                            </button>

                           <%-- <div id="box1" style="width:240px; height:200px; background: #eee; ">
                                <div class="layui-layer-content">是否确定删除？</div>
                            ...
                            <div class="col-md-10">
                                ...
                                <colgroup>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <select class="form-control inputWidth" id="maintenanceUnit" <%--disabled="disabled"--%>>
                                           <%-- <option value="0">--请选择--</option>--%>
                                            </select>
                                        </td>
                                        ...
                                        <td class="text-left">
                                            <select class="form-control inputWidth" id="buildId" <%--disabled="disabled"--%>>
                                                <%-- <option value="0">--请选择--</option>--%>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <select class="form-control inputWidth" id="buildAreaId" <%--disabled="disabled"--%>>
                                                <%-- <option value="0">--请选择--</option>--%>
                                            </select>
                                        </td>
...
<script src="/js/page_js/Maintenance/weibaoPlan.js"></script>
</html>