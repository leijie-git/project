			...
			<div class="col-md-12">
				<div class="jy_wrapper">
					<ul class="jy_title">
						...
						<li class="no_active"><span class="title">代码组管理</span></li>
					</ul>
					<div class="jy_mainTile panel-heading" style="display: none" clickNo="0">
						<div class="form-inline">
							<div class="form-group">
								<label for="identityNo" class="control-label">编码<strong>
										:</strong></label> <input type="text" class="form-control" name="codegroupkey"
									id="codegroupkey">
								<label for="identityNo" class="control-label">中文名称<strong>
										:</strong></label> <input type="text" class="form-control" name="codegroupname"
									id="codegroupname">
							</div>
						...
						<div class="form-inline">
							<div class="form-group">
								<select name="menuType" id="menuType" class="form-control">
									<option value="codegroupkey">编码</option>
									<option value="codegroupname">中文名称</option>
							...
							<div class="col-md-6">
								<div class="">
									<table class="table tableNo">
										<tr>
											<td class="text-right">编码<font style="color: red">*</font><strong>
													:</strong>
											</td>
											<td class="text-left"><input type="text"
												class="form-control inputNormal" id="newCodeGroup-codegroupkey" >
											</td>
										</tr>
										<tr>
											<td class="text-right">中文名称<strong>
													:</strong>
											</td>
											<td class="text-left"><input type="text"
												class="form-control inputNormal" id="newCodeGroup-codegroupname" >
											</td>
										</tr>
										<tr>
											<td class="text-right">排序顺序号<strong>
													:</strong>
											</td>
											<td class="text-left"><input type="text"
												class="form-control inputNormal" id="newCodeGroup-sortorder" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入数字" >
											</td>
										</tr>
										<tr>
											<td class="text-right password">说明<strong>
													:</strong>
											</td>
											<td class="text-left password"><input type="text"
												class="form-control inputNormal" id="newCodeGroup-memo" >
											</td>
										</tr>
									</table>
								</div>
								...
								<div class="">
									<table class="table tableNo">
										<tr>
											...
											<td class="text-left"><input type="text"
												class="form-control inputNormal" id="newCodeGroupView-codegroupkey" readonly="readonly">
											</td>
										</tr>
										<tr>
											<td class="text-right">中文名称<strong>
											...
											<td class="text-left"><input type="text"
												class="form-control inputNormal" id="newCodeGroupView-codegroupname" readonly="readonly">
											</td>
										</tr>
										<tr>
											<td class="text-right">排序顺序号<strong>
											...
											<td class="text-left"><input type="text"
												class="form-control inputNormal" id="newCodeGroupView-sortorder" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入数字" readonly="readonly">
											</td>
										</tr>
										<tr>
											...
											<td class="text-left password"><input type="text"
												class="form-control inputNormal" id="newCodeGroupView-memo" readonly="readonly">
											</td>
										</tr>
									</table>
								</div>
...
<script src="/js/page_js/systemManage/codeGroup.js"></script>
</html>