...
$(function () {
    ...
    //    //downloadWebComponent("divPlugin");
    //    window.open("/Scripts/codebase/WebComponents.exe");
    //    return;
    //}
    ...
    //    alert("检测到新的插件版本，请下载最新WebComponents.exe升级！");
    //    window.open("/Scripts/codebase/WebComponents.exe");
    //    //downloadWebComponent("divPlugin");
    //    return;
    //}
...
function downloadWebComponent(div) {
    ...
    div.append("<div style='width:100%;height:20px;background-color:lightblue;padding-top:10px;padding-left:10px;text-decoration:underline;'><a href='../Script/codebase/WebComponents.exe'>点击下载海康威视视频预览组件(WebComponent.exe)</a></div>");
}
