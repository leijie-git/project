...
function downloadWebComponent(div) {
    ...
    div.append("<div style='width:100%;height:20px;background-color:lightblue;padding-top:10px;padding-left:10px;text-decoration:underline;'><a href='../../../Script/Video/hik/webcomponent/WebComponents.exe'>点击下载海康威视视频预览组件(WebComponent.exe)</a></div>");
}
...
// 获取数字通道
function clickGetDigitalChannelInfo(cc) {
	var szIP = cc.CameraIP,
		iAnalogChannelNum = 0;
...
// 开始对讲
function clickStartVoiceTalk(cc) {
	var szIP = cc.CameraIP,
		iAudioChannel = 10,
		szInfo = "";
...
// 停止对讲
function clickStopVoiceTalk(cc) {
	var szIP = cc.CameraIP,
...
function clickStartDownloadRecord(cc,i) {
	var szIP =cc.CameraIP,
		szChannelID = cc.ChannelNum,
...
// 导出配置文件
function clickExportDeviceConfig(cc) {
	var szIP =cc.CameraIP,
		szInfo = "";
...
// 导入配置文件
function clickImportDeviceConfig(cc) {
	var szIP = cc.CameraIP,
...
function clickRestoreDefault(cc) {
    var szIP = cc.CameraIP,
        szMode = "basic";
